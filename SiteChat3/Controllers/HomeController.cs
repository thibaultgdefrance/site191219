            ...
            try
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        /*string mailInscrit = email;
                        string messageEmail = "bienvenue sur le site cucarachat.com pour finaliser votre compte veillez suivre ce liens " + "Hom/Validation/" + Utilisateur.TokenUtilisateur;
                        string sujet = "validation de compte cucarachat.com";
                        Workflow smtp = new Workflow;
                        smtp.envoiMail(mailInscrit, sujet, messageEmail);*/
